...
|---------------|----------------------------|--------------------------------------------------------------------------------------------------|-------------------------|
| Fuel Tank     |<ul><li>Inspect aluminum fuel tank for cracks or leakage<li>Inspect engine mount and vibration isolation system</ul> |  Drain Fuel tank. Remove and inspect fuel pickup assembly              ||                |
